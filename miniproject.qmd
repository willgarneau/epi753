...
#### Exponentiated 95% CI for crude model

```{r}
lincom(logbi_model_crude, "injher",eform=TRUE)
lincom(logbi_model_crude, "injcoc",eform=TRUE)
lincom(logbi_model_crude, "injher+injcoc+injcoc_injher",eform=TRUE)
```
...
#### exponentiated 95% CI for adjust model

```{r}
lincom(logbi_model, "injher",eform=TRUE)
lincom(logbi_model, "injcoc",eform=TRUE)
lincom(logbi_model, "injher+injcoc+injcoc_injher",eform=TRUE)
```
